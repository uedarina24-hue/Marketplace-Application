    ...
    <div class="address-edit__container">
        ...
        >
            ...
            <div class="address-edit__group">
                <label for="postal_code" class="address-edit__label">
                    郵便番号
                </label>
                <input
                    type="text"
            ...
            <div class="address-edit__group">
                <label for="address" class="address-edit__label">
                    住所
                </label>
                <input
                    type="text"
            ...
            <div class="address-edit__group">
                <label for="building_name" class="address-edit__label">
                    建物名
                </label>
                <input
                    type="text"
            ...
            <button class="address-edit__submit">
                更新する
            </button>
        </form>
    </div>
